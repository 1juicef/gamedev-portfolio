...
async function gifToMp4(inputGif, outputMp4) {
    ...
    console.log(`gifToMp4: ${outputMp4}`);
}
...
// Video thumbnail manifest: [projectFolder, gifBasename]
...
async function convertVideos() {
    for (const [folder, basename] of videoAssets) {
        ...
        await gifToMp4(inputGif, outputMp4);
