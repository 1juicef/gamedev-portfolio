...
- 🔨 **v1.1 Game Jams Section** — Phase 4 (in progress)
...
**v1.1 Game Jams Section**

- [ ] **Phase 4: Game Jams Section** - A "Game Jams" subheading and two plain-text itch.io hyperlinks at the bottom of the `/game-projects` timeline
