...
- [x] 01-04-PLAN.md — Trim Floor 0 timeline video thumbnail to ~12.5s (gap closure, addresses G-01-5)
...
- [x] 02-01-PLAN.md — Finalize project copy: Drag Rush/Dispater team attribution, all 4 "About this game" blurb typo/wording fixes, Floor 0 itch.io link, warm hero confirm (CONT-02/03/04/05)
