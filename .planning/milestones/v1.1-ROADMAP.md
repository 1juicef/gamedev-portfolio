...
- [x] **Phase 4: Game Jams Section** - A "Game Jams" subheading and two plain-text itch.io hyperlinks at the bottom of the `/game-projects` timeline (completed 2026-07-23)
